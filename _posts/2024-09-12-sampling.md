...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/rejection_plot.png" class="img-fluid rounded z-depth-1" 
        caption="Figure 1. Rejection Sampling - Joint Distribution" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
    </div>
</div>
